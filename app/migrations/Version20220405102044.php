 ...
 */
final class Version20220405102044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_6472BE06286DA936 ON insurance_objects_types_fields (insurance_type_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6472BE06286DA936 ON insurance_objects_types_fields');
