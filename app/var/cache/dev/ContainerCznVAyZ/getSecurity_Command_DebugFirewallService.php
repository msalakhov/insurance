...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.9x22wb3'] ?? $container->get_ServiceLocator_9x22wb3Service()), ($container->privates['.service_locator.QXrAJGi'] ?? $container->load('get_ServiceLocator_QXrAJGiService')), ['user_secured_area' => [0 => ($container->privates['security.authenticator.form_login.user_secured_area'] ?? $container->load('getSecurity_Authenticator_FormLogin_UserSecuredAreaService'))]], true);
