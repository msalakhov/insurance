...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ClientFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/InsuranceObjectsTypesFixture.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ClientFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\InsuranceObjectsTypesFixture(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())), 'groups' => []]]);
